...
class AniketPage extends StatefulWidget {
  static const routeName = '/aniket-profile';

  const AniketPage({super.key});

  @override
  State<AniketPage> createState() => _AniketPageState();
}

class _AniketPageState extends State<AniketPage> {
  List<dynamic> posts = [];
  bool isLoading = true;

  Future<void> fetchPosts() async {
    var url = Uri.https(apiUrl, '/cloudinary-list/Aniket');
                      ...
                      child: Column(
                        children: [
                          Row(
                            ...
                            children: [
                              buildStatColumn("11", "posts"),
                              buildStatColumn("296", "followers"),
                              buildStatColumn("307", "following"),
                            ],
                          ),
                        ],
                      ),
